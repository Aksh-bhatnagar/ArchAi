...
export default function Navbar({ mode, setMode }: Props) {
  ...
  return (
    <div className="bg-[#0F172A] text-[#E5E7EB] h-18 w-screen top-0 flex absolute z-20 justify-between">
      <div className="flex">
        <h3 className="text-3xl py-4 pl-4 font-bold text-white cursor-pointer" onClick={handleLogo}>Arch</h3>
        <h3 className="text-3xl py-4 pr-4 font-bold text-sky-400 cursor-pointer" onClick={handleLogo}>AI</h3>
      </div>
