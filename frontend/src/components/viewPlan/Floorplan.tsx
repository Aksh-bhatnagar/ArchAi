...
export default function Floorplan() {
  ...
  //       <h1 className="text-3xl font-bold">AI Floorplan Generator</h1>
  //     </div>

  //       {/* Form Section */}
  //     <div className="row-auto gap-6">
  ...
  //                 />
  //               <Label htmlFor="living" className="cursor-pointer">
  //                 Include Living Room
  //               </Label>
  //             </div>
  //           </CardContent>
  ...
  //                 />
  //               <Label htmlFor="pooja" className="cursor-pointer">
  //                 Pooja Room
  //               </Label>
  //             </div>
  ...
  //               <CardDescription>
  //                 Your AI-generated floor plan design
  //               </CardDescription>
  //             </CardHeader>
  //             <CardContent>
  //               <div
  ...
  <div className="h-screen w-screen flex flex-col bg-black">
    {/* Header */}
    <div className="w-full bg-amber-300 p-4 shadow-md flex justify-center">
      <h1 className="text-3xl font-bold text-black">Floorplan Generator</h1>
    </div>
    ...
    <div className="flex flex-1 overflow-hidden">
      ...
      {/* ------- LEFT SIDEBAR FORM ------- */}
      <div className="w-1/3 bg-gray-900 text-white p-4 overflow-y-auto space-y-4">
